                ...
                <>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav" className="justify-content-end">
                        <Nav>
                            ...
                            <Nav.Link as={Link} to="/diet_history" eventKey="3">Diet History</Nav.Link>
                            <Nav.Link as={Link} to="/status" eventKey="4">View Status</Nav.Link>
                            <Nav.Link as={Link} to="/nutrition-search" eventKey="5">Nutrition Search</Nav.Link>
                            <Nav.Link as={Link} to="/HealthHub" eventKey="6">Health Hub</Nav.Link>
                            <Nav.Link as={Link} to="/Cart" eventKey="7">Cart</Nav.Link>
