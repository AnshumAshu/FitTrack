  ...
  return (
    <div>
      ...
      <div className="exercise d-flex flex-column align-items-center">
        ...
        <div>
          <button className='diet-btn d-flex flex-column  align-items-center justify-content-center' onClick={() => navigate("/exercise/diet")}>
            <img alt="diet" src={dietIcon} className="exercise-icon" />
            Diet
          </button>
        </div>
      </div>
